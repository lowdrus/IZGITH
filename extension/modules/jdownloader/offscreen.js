...
var scriptPath = chrome.runtime.getURL('modules/jdownloader/vendor/js/');
...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    ...
    if (!request || request.target !== 'offscreen' || sender.id !== chrome.runtime.id || sender.tab || (sender.url && sender.url !== chrome.runtime.getURL('sw.js'))) {
        return false;
    }
