...
if (window.myJDAddLinksToolbarInjected !== true) {
    ...
    function createIFrame(tabId) {
        ...
        if (!iframe) {
            ...
            iframe.setAttribute("src", chrome.runtime.getURL("modules/jdownloader/toolbar.html") + "?id=" + tabId);
        }
        return iframe;
    }
    ...
    function showAutoGrabberIndicator() {
        ...
        if (iframe == null) {
            ...
            iframe.setAttribute("frameborder", "0");
            iframe.setAttribute("src", chrome.runtime.getURL("modules/jdownloader/autograbber-indicator.html"));
