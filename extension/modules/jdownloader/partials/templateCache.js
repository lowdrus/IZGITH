angular.module('myjdWebextensionApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/directives/myaddlinkspanel.html',
    ...
    "                            width=\"16px\" src=\"/modules/jdownloader/images/icon32.png\"/>&nbsp;{{device.name}}</span>\n" +
    ...
    "                                    src=\"/modules/jdownloader/images/document.png\"/></label><input\n" +
    ...
    "                                    src=\"/modules/jdownloader/images/package.png\"/></label><input\n" +
    ...
    "                                    src=\"/modules/jdownloader/images/saveto.png\"/></label><input\n" +
    ...
    "                                    src=\"/modules/jdownloader/images/archive_password.png\"/></label><input\n" +
    ...
    "                                    src=\"/modules/jdownloader/images/download_password.png\"/></label><input\n" +
